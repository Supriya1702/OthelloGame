...
public class GameActivity extends Activity implements View.OnClickListener {
    ...
    public static final String TAG="hint";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButtons[0][0] = findViewById(R.id.board11);
        imageButtons[0][1] = findViewById(R.id.board12);
        imageButtons[0][2] = findViewById(R.id.board13);
        imageButtons[0][3] = findViewById(R.id.board14);
        imageButtons[0][4] = findViewById(R.id.board15);
        imageButtons[0][5] = findViewById(R.id.board16);
        imageButtons[0][6] = findViewById(R.id.board17);
        imageButtons[0][7] = findViewById(R.id.board18);
        imageButtons[1][0] = findViewById(R.id.board21);
        imageButtons[1][1] = findViewById(R.id.board22);
        imageButtons[1][2] = findViewById(R.id.board23);
        imageButtons[1][3] = findViewById(R.id.board24);
        imageButtons[1][4] = findViewById(R.id.board25);
        imageButtons[1][5] = findViewById(R.id.board26);
        imageButtons[1][6] = findViewById(R.id.board27);
        imageButtons[1][7] = findViewById(R.id.board28);
        imageButtons[2][0] = findViewById(R.id.board31);
        imageButtons[2][1] = findViewById(R.id.board32);
        imageButtons[2][2] = findViewById(R.id.board33);
